...
fig = ggarrange(fig1, fig2, fig3, labels = c("a", "b", "c"), ncol = 3)
fig
ggsave("../figures/supp/sim_fixed_batch_effects.jpeg", width = 8, height = 5, dpi = 100)
ggsave("../figures/supp/sim_fixed_batch_effects.pdf", width = 8, height = 5)
```
...
dmy = dummyVars(" ~ cat_cov", data = smd)
...
fig = res_merge %>%
  ...
  theme(axis.text.x = element_text(angle = 60, vjust = 0.5),
        legend.position = "top")
fig
ggsave("../figures/supp/sim_fixed_sens.jpeg", width = 10, height = 5, dpi = 100)
ggsave("../figures/supp/sim_fixed_sens.pdf", width = 10, height = 5)
```
...
df_ancombc2 = read_csv("../outputs/sim_fixed/cont/sim_cont_ancombc2.csv")
df_ancombc = read_csv("../outputs/sim_fixed/cont/sim_cont_ancombc.csv")
df_linda = read_csv("../outputs/sim_fixed/cont/sim_cont_linda.csv")
df_locom = read_csv("../outputs/sim_fixed/cont/sim_cont_locom.csv")
...
```{r, fig.width=10, fig.height=8}
df_ancombc2 = read_csv("../outputs/sim_fixed/bin/sim_bin_ancombc2.csv")
df_ancombc = read_csv("../outputs/sim_fixed/bin/sim_bin_ancombc.csv")
df_linda = read_csv("../outputs/sim_fixed/bin/sim_bin_linda.csv")
df_locom = read_csv("../outputs/sim_fixed/bin/sim_bin_locom.csv")
...
df_ancombc2 = read_csv("../outputs/sim_fixed/cat/sim_dunn_ancombc2.csv")
df_ancombc = read_csv("../outputs/sim_fixed/cat/sim_dunn_ancombc.csv")
df_linda = read_csv("../outputs/sim_fixed/cat/sim_dunn_linda.csv")
...
```{r, fig.height=8, fig.width=10}
df = read_csv("../outputs/sim_fixed/cat/sim_pair_ancombc2.csv")
...
```{r, fig.height=8, fig.width=10}
df = read_csv("../outputs/sim_fixed/cat/sim_trend.csv")
...
```{r}
df = read_csv("../outputs/sim_fixed/cat/sim_trend_alter.csv")
...
```{r}
saveWorkbook(wb, file = "../outputs/sim_summ/summ_fixed.xlsx", overwrite = TRUE)
...
ggsave("../figures/main/sim_fixed1.jpeg", width = 10, height = 12, dpi = 100)
ggsave("../figures/main/sim_fixed1.pdf", width = 10, height = 12)

fig2 = ggarrange(fig_fdr_pair, fig_power_pair, fig_fdr_trend, fig_power_trend,
                 ncol = 1, labels = c("a", "", "b", ""), 
                 common.legend = TRUE, legend = "bottom")
ggsave("../figures/main/sim_fixed2.jpeg", width = 10, height = 10, dpi = 100)
ggsave("../figures/main/sim_fixed2.pdf", width = 10, height = 10)
```
