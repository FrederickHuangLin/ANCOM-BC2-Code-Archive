...
df_ancombc2 = read_csv("../outputs/sim_mixed/sim_int_ancombc2.csv")
df_linda = read_csv("../outputs/sim_mixed/sim_int_linda.csv")
...
```{r, fig.width=10, fig.height=6.25}
df_ancombc2 = read_csv("../outputs/sim_mixed/sim_slope_ancombc2.csv")
df_linda = read_csv("../outputs/sim_mixed/sim_slope_linda.csv")
...
```{r}
saveWorkbook(wb, file = "../outputs/sim_summ/summ_mixed.xlsx", overwrite = TRUE)

fig = ggarrange(fig_fdr1, fig_power1, fig_fdr2, fig_power2,
                ncol = 1, labels = c("a", "", "b", ""), 
                common.legend = TRUE, legend = "bottom")
ggsave("../figures/main/sim_mixed.jpeg", width = 10, height = 10, dpi = 100)
ggsave("../figures/main/sim_mixed.pdf", width = 10, height = 10)
```
