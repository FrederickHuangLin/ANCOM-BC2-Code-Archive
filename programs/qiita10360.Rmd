...
write_csv(df_fig, "../outputs/qiita_10360/res_alpha.csv")
...
saveRDS(output, "../outputs/qiita_10360/res_ancombc2.rds")
```

```{r}
output = read_rds(file = "../outputs/qiita_10360/res_ancombc2.rds")
...
write_csv(res_trend %>%
          ...
          "../outputs/qiita_10360/res_ancombc2_trend.csv")

write_csv(res_pair %>%
            arrange(desc(diff_aridityHyperarid_aridityMargin)), 
          "../outputs/qiita_10360/res_ancombc2_pair.csv")
```
...
write_csv(df_zero, "../outputs/qiita_10360/res_presence_absence.csv")
```
...
fig_sens = tab_sens %>%
  ...
  theme(axis.text.x = element_text(angle = 60, vjust = 0.5),
        legend.position = "top")
fig_sens
ggsave("../figures/supp/qiita_10360_sens.jpeg", width = 8, height = 8, dpi = 100)
ggsave("../figures/supp/qiita_10360_sens.pdf", width = 8, height = 8)
```
...
ggsave("../figures/main/qiita_10360.jpeg", width = 10, height = 6, dpi = 100)
ggsave("../figures/main/qiita_10360.pdf", width = 10, height = 6)
...
fig_supp = ggarrange(heat_arid, heat_margin, heat_hyperarid, leg, 
               ncol = 2, nrow = 2, 
               labels = c("a", "b", "c", ""))
ggsave("../figures/supp/qiita_10360_corr.jpeg", width = 16, height = 12, dpi = 100)
ggsave("../figures/supp/qiita_10360_corr.pdf", width = 16, height = 12)
```
