---
title: "Simulations for Fixed Effects Models: Upper Respiratory Tract Microbiome Data"
...
df_tab = df_fig %>%
  unite("setting", n:diff_prop, sep = ", ")
df_tab$setting = factor(df_tab$setting, 
                        levels = c(paste0("20, ", c(0.05, 0.1, 0.2, 0.5, 0.9)),
                                   paste0("40, ", c(0.05, 0.1, 0.2, 0.5, 0.9)),
                                   paste0("60, ", c(0.05, 0.1, 0.2, 0.5, 0.9)),
                                   paste0("100, ", c(0.05, 0.1, 0.2, 0.5, 0.9)),
                                   paste0("200, ", c(0.05, 0.1, 0.2, 0.5, 0.9))))
...
df_ancombc2 = read_csv("../data/urt/sim_fixed/cat/urt_sim_dunn_ancombc2.csv")
df_ancombc = read_csv("../data/urt/sim_fixed/cat/urt_sim_dunn_ancombc.csv")
df_linda = read_csv("../data/urt/sim_fixed/cat/urt_sim_dunn_linda.csv")
...
df_tab = df_fig %>%
  unite("setting", n:diff_prop, sep = ", ")
df_tab$setting = factor(df_tab$setting, 
                        levels = c(paste0("30, ", c(0.05, 0.1, 0.2, 0.5, 0.9)),
                                   paste0("60, ", c(0.05, 0.1, 0.2, 0.5, 0.9)),
                                   paste0("90, ", c(0.05, 0.1, 0.2, 0.5, 0.9)),
                                   paste0("150, ", c(0.05, 0.1, 0.2, 0.5, 0.9)),
                                   paste0("300, ", c(0.05, 0.1, 0.2, 0.5, 0.9))))
...
```{r, fig.height=8, fig.width=10}
df = read_csv("../data/urt/sim_fixed/cat/urt_sim_pair_ancombc2.csv")
...
```{r, fig.height=8, fig.width=10}
df_ancombc2 = read_csv("../data/urt/sim_fixed/cat/urt_sim_trend_ancombc2.csv")
...
```{r}
saveWorkbook(wb, file = "../results/outputs/urt_sim_summ_fixed.xlsx", overwrite = TRUE)

fig1 = ggarrange(fig_fdr_cont, fig_power_cont, 
                 fig_fdr_bin, fig_power_bin,
                 ncol = 1, labels = c("a", "", "b", ""), 
                 common.legend = TRUE, legend = "bottom")
ggsave(filename = "../results/figures/main_urt_sim_fixed1.jpeg", 
       plot = fig1, width = 12, height = 12, dpi = 100)
ggsave(filename = "../results/figures/main_urt_sim_fixed1.pdf", 
...
fig2 = ggarrange(fig_fdr_dunn, fig_power_dunn, 
                 ...
                 common.legend = TRUE, legend = "bottom")
ggsave(filename = "../results/figures/main_urt_sim_fixed2.jpeg",
       plot = fig2, width = 12, height = 14, dpi = 100)
ggsave(filename = "../results/figures/main_urt_sim_fixed2.pdf",
