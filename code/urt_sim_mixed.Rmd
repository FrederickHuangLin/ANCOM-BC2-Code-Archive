---
title: "Simulations for Mixed Effects Models: Upper Respiratory Tract Microbiome Data"
...
df_ancombc2 = read_csv("../data/urt/sim_mixed/urt_sim_int_ancombc2.csv")
df_linda = read_csv("../data/urt/sim_mixed/urt_sim_int_linda.csv")
df_clr = read_csv("../data/urt/sim_mixed/urt_sim_int_clr.csv")
...
```{r, fig.width=10, fig.height=6.25}
df_ancombc2 = read_csv("../data/urt/sim_mixed/urt_sim_slope_ancombc2.csv")
df_linda = read_csv("../data/urt/sim_mixed/urt_sim_slope_linda.csv")
df_clr = read_csv("../data/urt/sim_mixed/urt_sim_slope_clr.csv")
...
```{r}
saveWorkbook(wb, file = "../results/outputs/urt_sim_summ_mixed.xlsx", overwrite = TRUE)

fig = ggarrange(fig_fdr_int, fig_power_int, fig_fdr_slope, fig_power_slope,
                ncol = 1, labels = c("a", "", "b", ""), 
                common.legend = TRUE, legend = "bottom")
ggsave(filename = "../results/figures/main_urt_sim_mixed.jpeg", 
       plot = fig, width = 12, height = 12, dpi = 100)
ggsave(filename = "../results/figures/main_urt_sim_mixed.pdf", 
