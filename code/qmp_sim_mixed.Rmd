...
## Linear Mixed Models on CLR-Transformed Data
...
df_clr = read_csv("../data/qmp/sim_mixed/qmp_sim_int_clr.csv")
...
fig_power_int = df_fig %>%
  ...
  scale_color_manual(values = c("#E64B35FF", "#4DBBD5FF", "#F39B7FFF", "#91D1C2FF")) +
...
df_clr = read_csv("../data/qmp/sim_mixed/qmp_sim_slope_clr.csv")
...
ggsave(filename = "../results/figures/supp_qmp_sim_mixed.jpeg", 
       plot = fig, width = 12, height = 12, dpi = 100)
ggsave(filename = "../results/figures/supp_qmp_sim_mixed.pdf", 
       plot = fig, width = 12, height = 12)
```
