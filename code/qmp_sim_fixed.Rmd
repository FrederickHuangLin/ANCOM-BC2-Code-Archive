...
fig_power_pair = df_fig %>%
  ggline(x = "n", y = "X1", add = "mean_se",
         ...
         size = 0.2, shape = 20) +
  scale_x_discrete(labels = c(10, 20, 30, 50, 100)) +
  scale_y_continuous(limits = c(0.6, 1.1), breaks = seq(0.6, 1, 0.2)) +
  guides(color = guide_legend(title = NULL)) +
  theme(axis.text = element_text(size = 8),
        axis.title = element_text(size = 10),
        legend.text = element_text(size = 10),
...
fig_power_trend = df_fig %>%
  ggline(x = "n", y = "X1", add = c("mean_se"),
         color = "method", palette = "npg",
         xlab = "Sample Size", ylab = "Power", 
         facet.by = "diff_prop", nrow = 1,
         size = 0.2, shape = 20) +
  scale_x_discrete(labels = c(10, 20, 30, 50, 100)) +
  scale_y_continuous(limits = c(0.4, 1.1), breaks = seq(0.4, 1, 0.2)) +
  guides(color = guide_legend(title = NULL)) +
  theme(axis.text = element_text(size = 8),
        axis.title = element_text(size = 10),
        legend.text = element_text(size = 10),
...
ggsave(filename = "../results/figures/extend_qmp_sim_fixed1.jpeg", 
       plot = fig1, width = 180, height = 180, units = "mm", dpi = 300)
...
fig2 = ggarrange(fig_fdr_dunn, fig_power_dunn, 
                 ...
                 common.legend = TRUE, legend = "bottom")
ggsave(filename = "../results/figures/extend_qmp_sim_fixed2.jpeg",
       plot = fig2, width = 180, height = 210, units = "mm", dpi = 300)
```
