---
title: "Simulations for Fixed Effects Models: Quantitative Microbiome Project Data"
...
df_ancombc2 = read_csv("../data/qmp/sim_fixed/cont/qmp_sim_cont_ancombc2.csv")
df_ancombc = read_csv("../data/qmp/sim_fixed/cont/qmp_sim_cont_ancombc.csv")
df_corncob = read_csv("../data/qmp/sim_fixed/cont/qmp_sim_cont_corncob.csv")
df_linda = read_csv("../data/qmp/sim_fixed/cont/qmp_sim_cont_linda.csv")
df_locom = read_csv("../data/qmp/sim_fixed/cont/qmp_sim_cont_locom.csv")
...
```{r, fig.width=10, fig.height=8}
df_ancombc2 = read_csv("../data/qmp/sim_fixed/bin/qmp_sim_bin_ancombc2.csv")
df_ancombc = read_csv("../data/qmp/sim_fixed/bin/qmp_sim_bin_ancombc.csv")
df_corncob = read_csv("../data/qmp/sim_fixed/bin/qmp_sim_bin_corncob.csv")
df_linda = read_csv("../data/qmp/sim_fixed/bin/qmp_sim_bin_linda.csv")
df_locom = read_csv("../data/qmp/sim_fixed/bin/qmp_sim_bin_locom.csv")
...
df_tab = df_fig %>%
  unite("setting", n:diff_prop, sep = ", ")
df_tab$setting = factor(df_tab$setting, 
                        levels = c(paste0("20, ", c(0.1, 0.2, 0.5, 0.9)),
                                   paste0("40, ", c(0.1, 0.2, 0.5, 0.9)),
                                   paste0("60, ", c(0.1, 0.2, 0.5, 0.9)),
                                   paste0("100, ", c(0.1, 0.2, 0.5, 0.9)),
                                   paste0("200, ", c(0.1, 0.2, 0.5, 0.9))))
...
1 categorical exposure (with three levels) + 1 continuous confounder
...
df_ancombc2 = read_csv("../data/qmp/sim_fixed/cat/qmp_sim_dunn_ancombc2.csv")
df_ancombc = read_csv("../data/qmp/sim_fixed/cat/qmp_sim_dunn_ancombc.csv")
df_linda = read_csv("../data/qmp/sim_fixed/cat/qmp_sim_dunn_linda.csv")
...
fig_power_dunn = df_fig %>%
  ggline(x = "n", y = "X1", add = "mean_se",
         ...
         facet.by = "diff_prop", nrow = 1,
         size = 0.2, point.size = 0.1) +
  scale_color_manual(values = c("#E64B35FF", "#4DBBD5FF", "#00A087FF", "#F39B7FFF")) +
  scale_x_discrete(labels = c(10, 20, 30, 50, 100)) +
  guides(color = guide_legend(title = NULL))
                  ...
                  .packages = c("ANCOMBC", "tidyverse")) %dorng% 
  {
    ...
    res_merge2 = res_pair %>%
      dplyr::transmute(taxon, 
                       lfc_est1 = lfc_cat_cov2 * diff_cat_cov2 * passed_ss_cat_cov2,
                       lfc_est2 = lfc_cat_cov3 * diff_cat_cov3 * passed_ss_cat_cov3,
                       lfc_est3 = lfc_cat_cov3_cat_cov2 * diff_cat_cov3_cat_cov2* passed_ss_ccat_cov3_cat_cov2) %>%
      dplyr::left_join(fmd %>%
                         dplyr::transmute(taxon, 
                                          lfc_true1 = lfc_cat2_vs_1,
                                          lfc_true2 = lfc_cat3_vs_1,
...
```{r, fig.height=8, fig.width=10}
df = read_csv("../data/qmp/sim_fixed/cat/qmp_sim_pair_ancombc2.csv")
...
```{r, fig.height=8, fig.width=10}
df_ancombc2 = read_csv("../data/qmp/sim_fixed/cat/qmp_sim_trend_ancombc2.csv")
...
fig_trend = ggarrange(fig_fdr_trend, fig_power_trend, 
                      ncol = 1, common.legend = TRUE)
...
```{r}
saveWorkbook(wb, file = "../results/outputs/qmp_sim_summ_fixed.xlsx", overwrite = TRUE)

fig1 = ggarrange(fig_fdr_cont, fig_power_cont, 
                 fig_fdr_bin, fig_power_bin,
                 ncol = 1, labels = c("a", "", "b", ""), 
                 common.legend = TRUE, legend = "bottom")
ggsave(filename = "../results/figures/supp_qmp_sim_fixed1.jpeg", 
       plot = fig1, width = 12, height = 12, dpi = 100)
ggsave(filename = "../results/figures/supp_qmp_sim_fixed1.pdf", 
       plot = fig1, width = 12, height = 12)

fig2 = ggarrange(fig_fdr_dunn, fig_power_dunn, 
                 fig_fdr_pair, fig_power_pair, 
                 fig_fdr_trend, fig_power_trend,
                 ncol = 1, labels = c("a", "", "b", "", "c", ""),
                 common.legend = TRUE, legend = "bottom")
ggsave(filename = "../results/figures/supp_qmp_sim_fixed2.jpeg",
       plot = fig2, width = 12, height = 14, dpi = 100)
ggsave(filename = "../results/figures/supp_qmp_sim_fixed2.pdf",
       plot = fig2, width = 12, height = 14)
```
